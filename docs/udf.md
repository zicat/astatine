...
| [timestamp_to_date(param1,param2)](../astatine-functions/src/main/java/name/zicat/astatine/functions/Timestamp2Date.java) | udf_time      | Return the int date by long or timestamp(3) of param1 and option timezone of params2 like 'GMT+8',default params2 is 'GMT' |
| [timestamp_to_hour(param1,param2)](../astatine-functions/src/main/java/name/zicat/astatine/functions/Timestamp2Hour.java) | udf_time      | Return the int date by long or timestamp(3) of param1 and option timezone of params2 like 'GMT+8',default params2 is 'GMT' |
