...
import name.zicat.astatine.streaming.sql.runtime.map.DateHourExpansionFlatMapFunctionFactory;
...
public class DateHourExpansionFlatMapFunctionFactoryTest extends TransformFactoryTestBase {

  @Test
  public void testCrossHourIn1min() throws Exception {
    final var configuration = new Configuration();
    final var zoneId = ZoneId.of("GMT");
    final var maxPartitionCount = 4;
    configuration.set(OPTION_FUNCTION_IDENTITY, DateHourExpansionFlatMapFunctionFactory.IDENTITY);
    ...
    TransformFactoryTestBase.execAndAssert(
        ...
        data -> {
          ...
          Assert.assertEquals(0, ((RowData) data.get(0)).getInt(5));
          Assert.assertEquals(23, ((RowData) data.get(1)).getInt(5));
        });
  }
  ...
  public void test() throws Exception {
    ...
    final var maxPartitionCount = 4 * 24;
    configuration.set(OPTION_FUNCTION_IDENTITY, DateHourExpansionFlatMapFunctionFactory.IDENTITY);
    configuration.set(OPTION_TIME_ZONE, zoneId.getId());
    configuration.set(OPTION_FIELD_START_TS, "start_ts");
    configuration.set(OPTION_FIELD_END_TS, "end_ts");
    ...
    TransformFactoryTestBase.execAndAssert(
        ...
        data -> {
          ...
          Assert.assertEquals(currentDate - 1, n1List.get(0).getInt(5));
          Assert.assertEquals(6, n1List.get(0).getInt(6));
          Assert.assertEquals(currentDate - 1, n1List.get(1).getInt(5));
          Assert.assertEquals(7, n1List.get(1).getInt(6));
          Assert.assertEquals(23, n1List.get(17).getInt(6));
          Assert.assertEquals(0, n1List.get(18).getInt(6));
          Assert.assertEquals(49, n1List.size());
          Assert.assertEquals(currentDate + 1, n1List.get(48).getInt(5));
          Assert.assertEquals(6, n1List.get(48).getInt(6));

          // has current no start end
          final var n2List = filterByName(data, "name2");
          Assert.assertEquals(maxPartitionCount, n2List.size());
          Assert.assertEquals(currentDate - 4, n2List.get(0).getInt(5));
          Assert.assertEquals(7, n2List.get(0).getInt(6));
          Assert.assertEquals(currentDate, n2List.get(maxPartitionCount - 1).getInt(5));
          Assert.assertEquals(6, n2List.get(maxPartitionCount - 1).getInt(6));
          ...
          Assert.assertEquals(currentDate - 3, n4List.get(0).getInt(5));
          Assert.assertEquals(7, n4List.get(0).getInt(6));
          Assert.assertEquals(currentDate + 1, n4List.get(maxPartitionCount - 1).getInt(5));
          Assert.assertEquals(6, n4List.get(maxPartitionCount - 1).getInt(6));
          ...
          for (final RowData row : n5List) {
            ...
            Assert.assertEquals(6, row.getInt(6));
          }
        });
  }
  ...
  private static final Comparator<Object> LAST_VALUE_ASC =
      (o1, o2) -> {
        ...
        int result =
            Integer.compare(row1.getInt(row1.getArity() - 2), row2.getInt(row2.getArity() - 2));
        if (result != 0) {
          return result;
        }
