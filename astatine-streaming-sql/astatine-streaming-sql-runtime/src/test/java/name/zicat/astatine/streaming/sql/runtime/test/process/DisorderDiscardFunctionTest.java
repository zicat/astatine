...
import name.zicat.astatine.streaming.sql.runtime.process.DisorderDiscardFunction;
...
/** Tests for {@link DisorderDiscardFunction}. */
public class DisorderDiscardFunctionTest {
  ...
  public void testObjectReuseCorruptsBufferedRows() throws Exception {
    final var function =
        new DisorderDiscardFunction(fieldGetter(ROW_TYPE, "ts"), InternalTypeInfo.of(ROW_TYPE));
