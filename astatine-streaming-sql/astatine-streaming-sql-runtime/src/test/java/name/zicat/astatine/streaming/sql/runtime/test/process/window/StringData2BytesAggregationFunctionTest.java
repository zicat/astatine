...
import name.zicat.astatine.streaming.sql.runtime.process.windows.StringData2BytesAggregationFunction;
import org.apache.flink.table.data.StringData;
import org.junit.Assert;
import org.junit.Test;

/** BinaryAggregationFunctionTest. */
public class StringData2BytesAggregationFunctionTest extends BytesAggregationFunctionTestBase {

  @Test
  public void test() {
    final var function = new StringData2BytesAggregationFunction();
    final var it =
        createIterator(
