...
public class Row2PojoMapFunction<T> extends RichMapFunction<Row, T> {
  ...
  private transient String mapFunctionCode;
  ...
  public void open(Configuration parameters) throws Exception {
    ...
    final Class<MapFunction<Row, T>> dynamicClass =
        AstatineCompileUtils.compile(classLoader, functionClassName, mapFunctionCode);
  ...
  private static String setMethodName(Field field) {
    ...
    final var fieldNameFormat = fieldName.substring(0, 1).toUpperCase() + fieldName.substring(1);
