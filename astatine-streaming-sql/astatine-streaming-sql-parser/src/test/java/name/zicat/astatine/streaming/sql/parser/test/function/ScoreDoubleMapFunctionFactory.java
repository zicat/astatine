...
/** ScoreDoubleMapFunctionFactory. */
public class ScoreDoubleMapFunctionFactory implements MapFunctionFactory<NameScore, NameScore> {

    @Override
    public MapFunction<NameScore, NameScore> createMap(TransformContext context) {
        return score -> new NameScore(score.getName(), score.getScore() * 2);
    }
