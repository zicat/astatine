...
/** MapTransformFactoryTest. */
public class MapTransformFactoryTest extends TransformFactoryTestBase {

    @Test
    public void test() throws Exception {

        final var context = createContext("score_double");
        final var testStream = env.fromElements(new NameScore("aaaa", 1), new NameScore("aaab", 2));
        final var factory =
                TransformFactory.findFactory(MapTransformFactory.IDENTITY)
                        .cast(MapTransformFactory.class);
