...
import name.zicat.astatine.streaming.sql.parser.transform.MinTransformFactory;
...
/** MinTransformFactoryTest. */
public class MinTransformFactoryTest extends TransformFactoryTestBase {
    ...
    public void test() throws Exception {
        ...
        final var factory =
                TransformFactory.findFactory(MinTransformFactory.IDENTITY)
                        .cast(MinTransformFactory.class);
        execAndAssert(
                factory.transform(
                        context,
                        testStream.keyBy(
