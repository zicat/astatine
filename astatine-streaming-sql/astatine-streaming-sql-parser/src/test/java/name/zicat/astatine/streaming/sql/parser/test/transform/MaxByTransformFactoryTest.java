...
import name.zicat.astatine.streaming.sql.parser.transform.MaxByTransformFactory;
...
/** MaxByTransformFactoryTest. */
public class MaxByTransformFactoryTest extends TransformFactoryTestBase {
    ...
    public void test() throws Exception {
        ...
        final var factory =
                TransformFactory.findFactory(MaxByTransformFactory.IDENTITY)
                        .cast(MaxByTransformFactory.class);
        execAndAssert(
                factory.transform(
                        context,
                        testStream.keyBy(
