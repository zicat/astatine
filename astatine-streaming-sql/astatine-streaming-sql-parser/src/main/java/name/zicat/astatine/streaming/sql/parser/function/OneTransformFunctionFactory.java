...
/** OneTransformFunctionFactory. */
public interface OneTransformFunctionFactory<DS extends DataStream<T1>, T1, T2>
   ...
   * @return return
   */
  DataStream<T2> transform(TransformContext context, DS stream);
}
