...
/** MinByFunctionFactory. */
public final class MinByFunctionFactory<K, I> implements OneKeyedTransformFunctionFactory<K, I, I> {

  public static final String IDENTITY = "aggregation_min_by";
    ...
    return AggregationFunctions.transformAggregationBy(
        ...
        new AggregationFunctions.AggregationByHandler<>() {
          ...
          public DataStream<I> aggregationByField(String field, boolean first) {
            return keyedStream.minBy(field, first);
          }

          @Override
          public DataStream<I> aggregationByPosition(int position, boolean first) {
            return keyedStream.minBy(position, first);
          }
        });
  }
