...
import static net.agkn.hll.HLLType.*;
...
public class HLL implements Cloneable {
  ...
  private CopyLongOpenHashSet explicitStorage;
  // storage used when #type is SPARSE, null otherwise
  private CopyInt2ByteOpenHashMap sparseProbabilisticStorage;
  ...
  public HLL(
    ...
    if (this.sparseOff) {
      ...
      final int largestPow2LessThanCutoff =
          (int) NumberUtil.log2((double) (this.m * this.regwidth) / this.shortWordLength);
      ...
      case EMPTY:
        {
          ...
          if (explicitThreshold > 0) {
            initializeStorage(EXPLICIT);
            explicitStorage.add(rawValue);
          } else if (!sparseOff) {
            initializeStorage(SPARSE);
   ...
   *     must be an instantiable type. (For instance, it cannot be {@link HLLType#UNDEFINED}.)
   */
  private void initializeStorage(final int type) {
    this.type = type;
    switch (type) {
      case 1:
        // nothing to be done
        break;
      case 2:
        this.explicitStorage = new CopyLongOpenHashSet();
        break;
      case 3:
        this.sparseProbabilisticStorage = new CopyInt2ByteOpenHashMap();
        break;
      case 4:
  ...
  /*package, for testing*/ void heterogenousUnion(final HLL other) {
    ...
    } else if (HLLType.EMPTY == (other.getType())) {
  ...
  public static HLL fromBytes(final byte[] bytes) {
    ...
    final int type = metadata.HLLType();
  ...
  public HLL(
      CopyLongOpenHashSet explicitStorage,
      CopyInt2ByteOpenHashMap sparseProbabilisticStorage,
      ...
      int valueMask,
      long pwMaxMask,
      double alphaMSquared,
      double smallEstimatorCutoff,
      double largeEstimatorCutoff) {
    this.explicitStorage = explicitStorage;
    this.sparseProbabilisticStorage = sparseProbabilisticStorage;
    this.probabilisticStorage = probabilisticStorage;
    this.type = type;
    this.log2m = log2m;
    this.regwidth = regwidth;
    ...
    this.explicitThreshold = explicitThreshold;
    this.shortWordLength = shortWordLength;
    this.sparseOff = sparseOff;
    this.sparseThreshold = sparseThreshold;
    this.m = m;
    this.mBitsMask = mBitsMask;
    this.valueMask = valueMask;
    this.pwMaxMask = pwMaxMask;
    this.alphaMSquared = alphaMSquared;
    this.smallEstimatorCutoff = smallEstimatorCutoff;
    this.largeEstimatorCutoff = largeEstimatorCutoff;
  }

  public HLL() {}

  public CopyLongOpenHashSet getExplicitStorage() {
    return explicitStorage;
  }

  public void setExplicitStorage(CopyLongOpenHashSet explicitStorage) {
    this.explicitStorage = explicitStorage;
  }

  public CopyInt2ByteOpenHashMap getSparseProbabilisticStorage() {
    return sparseProbabilisticStorage;
  }

  public void setSparseProbabilisticStorage(CopyInt2ByteOpenHashMap sparseProbabilisticStorage) {
    this.sparseProbabilisticStorage = sparseProbabilisticStorage;
  }

  public BitVector getProbabilisticStorage() {
    return probabilisticStorage;
  }

  public void setProbabilisticStorage(BitVector probabilisticStorage) {
    this.probabilisticStorage = probabilisticStorage;
  }
  ...
  public boolean isExplicitOff() {
    return explicitOff;
  }

  public void setExplicitOff(boolean explicitOff) {
    this.explicitOff = explicitOff;
  }

  public boolean isExplicitAuto() {
    return explicitAuto;
  }

  public void setExplicitAuto(boolean explicitAuto) {
    this.explicitAuto = explicitAuto;
  }
  ...
  public int getShortWordLength() {
    return shortWordLength;
  }

  public void setShortWordLength(int shortWordLength) {
    this.shortWordLength = shortWordLength;
  }

  public boolean isSparseOff() {
    return sparseOff;
  }

  public void setSparseOff(boolean sparseOff) {
    this.sparseOff = sparseOff;
  }
  ...
  public void setSparseThreshold(int sparseThreshold) {
    this.sparseThreshold = sparseThreshold;
  }
  ...
  public int getmBitsMask() {
    return mBitsMask;
  }

  public void setmBitsMask(int mBitsMask) {
    this.mBitsMask = mBitsMask;
  }
  ...
  public long getPwMaxMask() {
    return pwMaxMask;
  }

  public void setPwMaxMask(long pwMaxMask) {
    this.pwMaxMask = pwMaxMask;
  }

  public double getAlphaMSquared() {
    return alphaMSquared;
  }

  public void setAlphaMSquared(double alphaMSquared) {
    this.alphaMSquared = alphaMSquared;
  }

  public double getSmallEstimatorCutoff() {
    return smallEstimatorCutoff;
  }

  public void setSmallEstimatorCutoff(double smallEstimatorCutoff) {
    this.smallEstimatorCutoff = smallEstimatorCutoff;
  }

  public double getLargeEstimatorCutoff() {
    return largeEstimatorCutoff;
  }

  public void setLargeEstimatorCutoff(double largeEstimatorCutoff) {
    this.largeEstimatorCutoff = largeEstimatorCutoff;
  }
}
