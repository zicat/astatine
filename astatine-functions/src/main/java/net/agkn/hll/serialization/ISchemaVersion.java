...
public interface ISchemaVersion {
   ...
   * @see IWordSerializer
   */
  IWordSerializer getSerializer(int type, int wordLength, int wordCount);
   ...
   */
  IWordDeserializer getDeserializer(int type, int wordLength, byte[] bytes);
