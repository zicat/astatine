...
public class SchemaVersionOne implements ISchemaVersion {
   ...
   */
  @Override
  public int paddingBytes(final int type) {
   ...
   */
  @Override
  public IWordSerializer getSerializer(int type, int wordLength, int wordCount) {
   ...
   */
  @Override
  public IWordDeserializer getDeserializer(int type, int wordLength, byte[] bytes) {
   ...
   *     non-negative.
   */
  private static int getOrdinal(final int type) {
    return type;
  }
   ...
   */
  private static int getType(final int ordinal) {
    return ordinal;
  }
}
