...
public class BitVector implements Cloneable {
  ...
  private static int LOG2_BITS_PER_WORD = 6 /*=>64bits*/;
  private static int BITS_PER_WORD = 1 << LOG2_BITS_PER_WORD;
  private static int BITS_PER_WORD_MASK = BITS_PER_WORD - 1;

  // ditto from above but for bytes (for output)
  private static int LOG2_BITS_PER_BYTE = 3 /*=>8bits*/;
  public static int BITS_PER_BYTE = 1 << LOG2_BITS_PER_BYTE;

  // ========================================================================
  public static int BYTES_PER_WORD = 8 /*8 bytes in a long*/;
   ...
   */
  public BitVector(final int width, long count) {
  ...
  public long getRegister(final long registerIndex) {
    long bitIndex = registerIndex * registerWidth;
    int firstWordIndex = (int) (bitIndex >>> LOG2_BITS_PER_WORD) /*aka (bitIndex / BITS_PER_WORD)*/;
    int secondWordIndex =
        (int) ((bitIndex + registerWidth - 1) >>> LOG2_BITS_PER_WORD) /*see above*/;
    int bitRemainder = (int) (bitIndex & BITS_PER_WORD_MASK) /*aka (bitIndex % BITS_PER_WORD)*/;
   ...
   */
  // NOTE:  if this changes then setMaxRegister() must change
  public void setRegister(final long registerIndex, long value) {
    long bitIndex = registerIndex * registerWidth;
    int firstWordIndex = (int) (bitIndex >>> LOG2_BITS_PER_WORD) /*aka (bitIndex / BITS_PER_WORD)*/;
    int secondWordIndex =
        (int) ((bitIndex + registerWidth - 1) >>> LOG2_BITS_PER_WORD) /*see above*/;
    ...
    long[] words = this.words /*for convenience/performance*/;
    if (firstWordIndex == secondWordIndex) {
      // clear then set
  ...
  public boolean setMaxRegister(final long registerIndex, long value) {
    long bitIndex = registerIndex * registerWidth;
    int firstWordIndex = (int) (bitIndex >>> LOG2_BITS_PER_WORD) /*aka (bitIndex / BITS_PER_WORD)*/;
    int secondWordIndex =
        (int) ((bitIndex + registerWidth - 1) >>> LOG2_BITS_PER_WORD) /*see above*/;
  ...
  public BitVector clone() {
    BitVector copy = new BitVector(registerWidth, count);
  ...
  public BitVector(long[] words, int registerWidth, long count, long registerMask) {
    this.words = words;
  ...
  public static int getLog2BitsPerWord() {
    return LOG2_BITS_PER_WORD;
  }

  public static void setLog2BitsPerWord(int log2BitsPerWord) {
    LOG2_BITS_PER_WORD = log2BitsPerWord;
  }

  public static int getBitsPerWord() {
    return BITS_PER_WORD;
  }

  public static void setBitsPerWord(int bitsPerWord) {
    BITS_PER_WORD = bitsPerWord;
  }

  public static int getBitsPerWordMask() {
    return BITS_PER_WORD_MASK;
  }

  public static void setBitsPerWordMask(int bitsPerWordMask) {
    BITS_PER_WORD_MASK = bitsPerWordMask;
  }

  public static int getLog2BitsPerByte() {
    return LOG2_BITS_PER_BYTE;
  }

  public static void setLog2BitsPerByte(int log2BitsPerByte) {
    LOG2_BITS_PER_BYTE = log2BitsPerByte;
  }

  public static int getBitsPerByte() {
    return BITS_PER_BYTE;
  }

  public static void setBitsPerByte(int bitsPerByte) {
    BITS_PER_BYTE = bitsPerByte;
  }

  public static int getBytesPerWord() {
    return BYTES_PER_WORD;
  }

  public static void setBytesPerWord(int bytesPerWord) {
  ...
  public long getRegisterMask() {
    return registerMask;
  }

  public void setRegisterMask(long registerMask) {
    this.registerMask = registerMask;
  }
}
