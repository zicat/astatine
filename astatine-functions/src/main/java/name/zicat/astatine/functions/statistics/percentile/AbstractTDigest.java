...
public abstract class AbstractTDigest extends TDigest {
   ...
   * <code>x2</code> with a weight of <code>w2</code>. This expects <code>x1</code> to be less than
   * or equal to <code>x2</code> and is guaranteed to return a number in <code>[x1, x2]
   * </code>. An explicit check is required since this isn't guaranteed with floating-point numbers.
   */
