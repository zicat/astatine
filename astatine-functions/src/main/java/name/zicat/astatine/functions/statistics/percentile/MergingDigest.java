...
public class MergingDigest extends AbstractTDigest {
  ...
  public double publicCompression;
  public double compression;

  // points to the first unused centroid
  public int lastUsedCell;
   ...
   * typically loses a bit of precision and thus isn't a thing to be doing all the time. It is best
   * done only when we want to show results to the outside world.
   */
  @Override
