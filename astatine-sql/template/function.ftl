...
CREATE TEMPORARY SYSTEM FUNCTION IF NOT EXISTS to_date AS 'name.zicat.astatine.functions.Timestamp2Date' LANGUAGE JAVA;
CREATE TEMPORARY SYSTEM FUNCTION IF NOT EXISTS to_hour AS 'name.zicat.astatine.functions.Timestamp2Hour' LANGUAGE JAVA;
</#macro>
