...
/** AppendOnlyRowElasticsearchSinkFunctionFactory. */
public class AppendOnlyRowElasticsearchSinkFunctionFactory
    implements RowElasticsearchSinkFunctionFactory {

  @Override
  public String identity() {
    return "append_only_function";
  }
  ...
  public RowElasticsearchSinkFunction create(
    ...
    return new AppendOnlyRowElasticsearchSinkFunction(
